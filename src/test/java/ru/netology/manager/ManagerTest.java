...
class CRUDManagerTest {
    ...
    public class Empty{
        ...
        void shouldFilterByAuthor(){
            List<Issue> expected = new ArrayList<>();
            List<Issue> actual = manager.filterByAuthor("Vladimir");
            assertEquals(expected, actual);
    ...
    public class SingleItem {
        ...
        void shouldFilterByAuthor() {
            List<Issue> expected = new ArrayList<>(List.of(issue1));
            List<Issue> actual = manager.filterByAuthor("Georg");
            assertEquals(expected, actual);
    ...
    public class MultipleItems {
        private Repository repository = new Repository();
        private Manager manager = new Manager(repository);
        Issue issue1 = new Issue(1, true, "Georg", 1,
                new HashSet<>(Arrays.asList("Label-1", "Label-2", "Label-3")),
                new HashSet<>(Arrays.asList("Assignee-1", "Assignee-2", "Assignee-3")));
        Issue issue2 = new Issue(2, false, "Vladimir", 4,
                new HashSet<>(Arrays.asList("Label-5", "Label-3", "Label-4")),
                new HashSet<>(Arrays.asList("Assignee-5", "Assignee-3", "Assignee-4")));
        Issue issue3 = new Issue(3, true, "Georg", 3,
                new HashSet<>(Arrays.asList("Label-111", "Label-2", "Label-355")),
                new HashSet<>(Arrays.asList("Assignee-111", "Assignee-2", "Assignee-355")));
        Issue issue4 = new Issue(4, false, "Anna", 7,
                new HashSet<>(Arrays.asList("Label-7", "Label-22", "Label-32")),
                new HashSet<>(Arrays.asList("Assignee-7", "Assignee-22", "Assignee-32")));
        Issue issue5 = new Issue(5, true, "Dmitriy", 12,
                new HashSet<>(Arrays.asList("Label-2", "Label-23", "Label-3")),
                new HashSet<>(Arrays.asList("Assignee-2", "Assignee-23", "Assignee-3")));
        Issue issue6 = new Issue(6, true, "Georg", 2,
                new HashSet<>(Arrays.asList("Label-2", "Label-23", "Label-3")),
                new HashSet<>(Arrays.asList("Assignee-2", "Assignee-23", "Assignee-3")));
